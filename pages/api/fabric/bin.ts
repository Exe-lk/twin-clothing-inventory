// pages/api/fabric/bin.ts
import type { NextApiRequest, NextApiResponse } from 'next';
import { createFabric, getDeletedFabrics, updateFabric, deleteFabric } from '../../../service/fabricService';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    switch (req.method) {
      ...
      case 'GET': {
        const fabrics = await getDeletedFabrics();
