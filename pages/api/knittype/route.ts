// pages/api/knittype/route.ts
import type { NextApiRequest, NextApiResponse } from 'next';
import { createKnitType, getKnitTypes, updateKnitType, deleteKnitType } from '../../../service/knitTypeService';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    switch (req.method) {
      ...
      case 'GET': {
        const knitTypes = await getKnitTypes();
